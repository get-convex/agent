...
Note on versions: this component requires AI SDK v7 (`ai@^7`), which pairs
with **v4.x** of the AI SDK provider packages, e.g. `@ai-sdk/openai@^4`,
`@ai-sdk/anthropic@^4`, `@ai-sdk/google@^4` (and `@ai-sdk/provider-utils@^5`).
...
by installing the provider at `^4`, e.g.:

```sh
npm install ai@^7 @ai-sdk/anthropic@^4
```
